...
### 1. MLOps Engineer (strong profile)

```
Priya Sharma — MLOps Engineer
priya.sharma@email.com | github.com/priyasharma | linkedin.com/in/priyasharma

EXPERIENCE
Senior MLOps Engineer — FinTech Corp (2021–present)
- Built and maintained ML pipelines using Kubeflow and Apache Airflow serving 12 production models
- Reduced model deployment time from 3 days to 4 hours by implementing CI/CD with GitHub Actions and Docker
- Designed feature store on Redis with 99.9% uptime, serving 50M predictions/day
- Led model monitoring setup using Prometheus and Grafana; caught 3 major drift incidents before user impact

MLOps Engineer — DataDriven Inc (2019–2021)
- Containerised 8 legacy ML models using Docker and deployed to AWS ECS
- Implemented automated retraining pipelines triggered by data drift detection
- Maintained A/B testing framework for model rollouts

SKILLS
Python, FastAPI, Docker, Kubernetes, Kubeflow, MLflow, Airflow, Prometheus, Grafana, AWS (ECS, S3, SageMaker), Redis, PostgreSQL, GitHub Actions
...
arjun.mehta@email.com | github.com/arjunmehta

EXPERIENCE
Data Scientist — RetailAI (2022–present)
- Built customer churn prediction model with 87% accuracy using XGBoost, saving $2M annually
- Developed NLP pipeline for product review sentiment analysis using BERT fine-tuning
- Collaborated with engineering team to deploy models via REST APIs using FastAPI

Junior Data Scientist — Analytics House (2020–2022)
- Performed exploratory data analysis and feature engineering for 6 client projects
- Built dashboards in Tableau for business stakeholders
- Wrote SQL queries against BigQuery datasets of 100M+ rows

SKILLS
Python, scikit-learn, XGBoost, TensorFlow, PyTorch, BERT, FastAPI, SQL, BigQuery, Tableau, Pandas, NumPy

EDUCATION
MSc Data Science — University of Edinburgh, 2020
BSc Mathematics — Delhi University, 2018
```
...
### 3. Backend Engineer (API focus)

```
Sara Kim — Backend Engineer
sara.kim@email.com | github.com/sarakim

EXPERIENCE
Backend Engineer — CloudScale (2021–present)
- Designed and built REST APIs handling 10M requests/day using FastAPI and PostgreSQL
- Implemented async task queue with Celery and Redis, reducing p99 latency from 4s to 400ms
- Led migration of monolithic service to microservices architecture on Kubernetes
- Wrote comprehensive test suites with 90%+ coverage using pytest and httpx

Software Engineer — StartupXYZ (2019–2021)
- Built payment processing service integrated with Stripe API
- Implemented JWT authentication and role-based access control
- Contributed to Docker-based deployment workflow and CI/CD pipeline on GitHub Actions

SKILLS
Python, FastAPI, Django, PostgreSQL, Redis, Celery, Docker, Kubernetes, GitHub Actions, pytest, REST APIs, SQL

EDUCATION
BSc Computer Science — NUS, 2019
```
...
### 4. Fresh Graduate (weak profile — good for showing low ATS score)
...
EDUCATION
B.Tech Computer Science — Some College, 2024
CGPA: 7.2

PROJECTS
- Made a website for my college fest using HTML and CSS
- Built a to-do app in React by following a YouTube tutorial
- Did a machine learning project on the Titanic dataset for an internship

SKILLS
C, C++, Java, Python (basic), HTML, CSS, MS Word, MS Excel, PowerPoint

INTERNSHIP
Web Development Intern — Local Agency (2 months)
- Assisted in building client websites
- Fixed bugs in WordPress themes

HOBBIES
Cricket, watching anime, solving puzzles
```

**Target role:** `Machine Learning Engineer`

> Good for showing a low ATS score and a long missing skills list.

---

## Fun Resumes

### 5. The Overconfident One

```
Chad Thundercode — 10x Engineer & Visionary
chad@thundercode.io | thundercode.io | @ChadThundercode

EXPERIENCE
Lead Architect & CEO — Self-employed (2015–present)
- Personally rewrote the internet in a weekend
- Invented a new programming language that no one else can understand yet
- Disrupted 14 industries simultaneously using blockchain and AI synergy
- Managed a team of 1 (myself) with zero meetings and maximum productivity

Senior Rockstar Engineer — Stealth Startup (2013–2015)
- Used machine learning to solve problems that did not exist
- Achieved 10x performance improvement by deleting all the tests
- Introduced microservices to a 2-person team, tripling infrastructure costs

SKILLS
Every programming language ever written, 5 frameworks I invented myself,
Cloud (all of them), AI (the real kind), Leadership, Disruption, Hustle

EDUCATION
Self-taught. Books are for people who give up.

REFERENCES
Available upon request (they are all me under different names)
```
...
### 6. The Dragon (guardrail stress test — passes topicality, entertaining result)

```
Smaug the Magnificent — Principal Fire Breathing Engineer
smaug@misty-mountain.me | 400 years of experience

EXPERIENCE
Chief Treasure Guardian — Erebor (2600 BC–present)
- Managed and secured a distributed asset portfolio of 2.3 million gold pieces
- Led hostile takeover of mountain infrastructure with zero budget and one team member (me)
- Maintained 100% uptime on treasure monitoring systems for 171 years
- Skilled in threat detection, unauthorised access prevention, and scorched-earth incident response

Senior Menace — Wilderland Region (Before that)
- Delivered consistent results across multiple villages
- Strong stakeholder communication (mostly one-way)
- Experienced in large-scale data destruction and process simplification

SKILLS
Fire breathing, gold hoarding, riddle-solving, psychological warfare,
thermal imaging, cave navigation, stakeholder intimidation, Python (the snake, not the language)

EDUCATION
Ancient Dragon Academy — Top of class
Specialisation: Greed, Wrath, and Distributed Systems

REFERENCES
Bilbo Baggins (former interviewer) — bagginses@theshire.me
```

**Target role:** `Senior MLOps Engineer`

> Gemini will try its best to take this seriously. The result is always entertaining.

---

### 7. The Passive-Aggressive One

```
Alex Johnson — Software Engineer
definitely.not.bitter@email.com

EXPERIENCE
Senior Software Engineer — MegaCorp (2018–2024)
- Wrote all the code. All of it.
- Fixed bugs introduced by colleagues who "just wanted to try something"
- Attended 47 meetings that could have been emails
- Maintained legacy system that was supposed to be replaced in 2019
- Onboarded 6 new engineers who all got promoted before me

Software Engineer — StartupDream (2016–2018)
- Joined when it was "the next big thing"
- Left when it became the next cautionary tale
- Shipped a product used by dozens of people

SKILLS
Python, JavaScript, patience (depleted), SQL, mentoring people who leave,
documentation that no one reads, estimating tasks in story points (inaccurate)

EDUCATION
BSc Computer Science — State University, 2016
Thesis: "Why Did I Choose This"
